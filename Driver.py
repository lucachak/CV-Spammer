...
from components.read_planilha import Reader
...
class ArachneDriver:
    ...
    def execute():
        ...
        linkedin_parser = subparsers.add_parser(
            "scrape_linkedin", help="Inicia a caçada no LinkedIn (Caminho da Raposa)"
        )
        linkedin_parser.add_argument(
            "--debug",
            action="store_true",
            help="Modo debug: desabilita startup_jitter e delays de segurança",
        )
